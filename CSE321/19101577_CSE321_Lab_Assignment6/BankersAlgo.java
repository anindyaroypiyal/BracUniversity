...
public class BankersAlgo {
	public static void main(String[] args) throws Exception {
		BufferedReader b = new BufferedReader(new FileReader("C:\\Users\\royan\\eclipse-workspace\\fall_21\\src\\inp.txt"));
			...
			for (int j = 0 ; j < column; j++) {
				...
				if(flag && j == (column-1) && !track.contains(i)) {
					for(int k =0; k < column; k++) {
						available[counter+1][k] = available[counter][k] + alllocation[i][k];
